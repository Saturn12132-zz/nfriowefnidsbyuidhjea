...
local Themes = {
	...
	Aqua = {
		...
		MaximiseAccent = Color3.fromRGB(0, 255, 0),
		NavBar = Color3.fromRGB(0, 0, 255),
		NavBarAccent = Color3.fromRGB(0,0,0),
		NavBarInvert = Color3.fromRGB(255,255,255),
		TitleBar = Color3.fromRGB(4, 84, 211),
		TitleBarAccent = Color3.fromRGB(236,33,168),
		Overlay = Color3.fromRGB(189, 62, 220),
		Banner = Color3.fromRGB(172,150,9),
		BannerAccent = Color3.fromRGB(215, 162, 91),
		Content = Color3.fromRGB(111, 74, 80),
		Button = Color3.fromRGB(35, 184, 115),
		ButtonAccent = Color3.fromRGB(111, 152, 12),
		ChipSet = Color3.fromRGB(56, 149, 14),
		ChipSetAccent = Color3.fromRGB(168,50,125),
		DataTable = Color3.fromRGB(152, 62, 18),
		DataTableAccent = Color3.fromRGB(63, 14, 66),
		Slider = Color3.fromRGB(199,162,154),
		SliderAccent = Color3.fromRGB(231, 125, 49),
		Toggle = Color3.fromRGB(66, 70, 55),
		ToggleAccent = Color3.fromRGB(131,34,186),
		Dropdown = Color3.fromRGB(123,28,9),
		DropdownAccent = Color3.fromRGB(239, 132, 164),
		ColorPicker = Color3.fromRGB(66, 66, 224),
		ColorPickerAccent = Color3.fromRGB(231, 62, 11),
	...
	Nebula = {
		...
		Maximise = Color3.fromRGB(10, 10, 10),
		MaximiseAccent = Color3.fromRGB(10, 10, 10),
	...
	Monochrome = {
		...
		Minimise = Color3.fromRGB(0, 0, 0),
		MinimiseAccent = Color3.fromRGB(0, 0, 0),
		Maximise = Color3.fromRGB(100, 100, 100),
		MaximiseAccent = Color3.fromRGB(100, 100, 100),
		NavBar = Color3.fromRGB(0, 0, 0),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(200, 200, 200),
		TitleBarAccent = Color3.fromRGB(0,0,0),
